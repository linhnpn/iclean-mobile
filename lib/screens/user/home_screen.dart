                    ...
                    children: [
                      Row(
                        children: [
                          Container(
                            ...
                            child: CircleAvatar(
                              backgroundImage: Image.network(
                                'https://firebasestorage.googleapis.com/v0/b/hrm-resource.appspot.com/o/avatar.png?alt=media',
                          ...
                          Container(
                            padding: EdgeInsets.only(left: fem * 55),
                        ...
                        child: Row(
                          children: [
                            ...
                            GestureDetector(
                              ...
                              child: Text(
                                "Point: ${NumberFormat('# ###').format(money)} VNĐ",
                                style: const TextStyle(
                                  fontSize: 15,
                                  fontFamily: 'Lato',
                                  color: Colors.white,
